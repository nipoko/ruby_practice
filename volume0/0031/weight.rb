...
祖母は左の皿にジュースを、右の皿に 8g と64g と128g の分銅を載せて釣合わせてから、
...
File.readlines("./input.txt").each do |line|
  binary_keta = 0
  ret_data = []
  line.to_i.to_s(2).reverse.each_char do |binary_data|
    ret_data << 2 ** binary_keta if binary_data == "1"
    binary_keta += 1
  end
  puts ret_data.join(" ")
end
